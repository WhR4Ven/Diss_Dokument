...
Restiktionen bezüglich der Hardwarearchitektur müssen berücktsichtig werden. Der Scheduler muss erweitert werden, um Hardware-Restriktionen (z. B. B\enquote{enötigt ARM64 Architektur} oder \enquote{Benötigt NPU}) zu berücksichtigen und so die Heterogenität der Fahrzeugflotte abzubilden.
