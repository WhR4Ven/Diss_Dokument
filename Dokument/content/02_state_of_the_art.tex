...
Vehicular Fog Computing (VFC) Eine spezifische Ausprägung dieses Konzepts ist das Vehicular Fog Computing (VFC). Hierbei fungieren Fahrzeuge nicht nur als reine Datenerzeuger (Sensoren) oder Datenkonsumenten, sondern als aktive Infrastrukturknoten (\enquote{Fog Nodes}). Aufgrund ihrer leistungsstarken On-Board-Steuergeräte (siehe Abschnitt 2.7) und ihrer Energiespeicher verfügen moderne Fahrzeuge über Ressourcen, die weit über die herkömmlicher IoT-Sensoren hinausgehen. \cite{Hou2016}

VFC nutzt diese Ressourcen, um eine hochdynamische Fog-Schicht zu bilden. Geparkte oder langsam fahrende Fahrzeuge können als temporäre Server fungieren, um Rechenaufgaben für andere Verkehrsteilnehmer oder die städtische Infrastruktur zu übernehmen. Dies macht das Fahrzeug zu einem idealen Kandidaten für Fog-Knoten am äußersten Rand des Netzwerks (\enquote{Network Edge}), da es Rechenleistung genau dort bereitstellt, wo mobile Daten entstehen. \cite{Zhu2018}
