...
\begin{itemize}
	\item API Server: Der API server ist die API Schnittstelle für Kubernetes. 
\end{itemize}

Nodes können sich selber registrieren oder manuell hinzugefügt werden. FÜr die Registrierung ist die kubelet Komponente zuständig. 
