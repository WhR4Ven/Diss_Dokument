...
Das Compute Modul interagiert mit den Hypervisoren durch einen API Server. Es unterstützt verschiedene Hypervisoren, die in der Cloud auch gemischt werden können. Die Enwticklung findet hauptsächlich mit Kernelbasierten Virtuellen Maschine statt (KVM), die ein Modul des Linux Kernels ist.
