...
Container Orchestrierung übernimmt die automatische Platzierung, Skalierung und Management von containerisierte Applikationen. 

Eine der meistverbreiteten Implementierungen von Container Orchestrierungstools ist Kubernetes. Anhand dessen Funktionsweise und Architektur wird beispielhaft gezeigt, wie Tools für Container Orchestrierung umgesetzt werden können. 