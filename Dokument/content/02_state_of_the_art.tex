...
\begin{itemize}
	\item Mount Namespace: Isoliert das Dateisystem im Prozess. Der Prozess kann nur die Pfade im Dateisystem sehen und darauf zugreifen die explizit per mount() Funktion zum jeweiligen Namespace hinzugefügt wurden.
	\item UTS Namespace: Der Prozess 
	\item IPC Namespace:
	\item PID Namespace:
