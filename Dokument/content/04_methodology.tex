...
Die zweite Art der Kommunikation ist die Übertragung von Anwendungen. In diesem Konzept ist vorgesehen, dass diese im Binärformat als kompilierte ausführbare Datei vorliegen. Dateiübertragung kann mit verschiedenen Kommunikationsprotokollen stattfinden. Auch hier wird häufig das \gls{HTTP}/\gls{HTTPS} Protokoll verwendet. Alternativ 