...
Diese Funktion nimmt verschiedene Objekte in der Variable \enquote{Items} und Rucksäcke \enquote{Knapsacks}. Die Variable \enquote{Queue} beinhaltet alle Teillösungen, sortiert nach deren oberen Schranke. 
