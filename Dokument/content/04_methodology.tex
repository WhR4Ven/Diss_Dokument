...
Dynamische Programmierung ist eine Methode, die für sogenannte 0/1 Knapsackprobleme verwendet werden kann. 0/1 bedeutet, dass ein Objekt entweder ganz oder gar nicht ausgewählt wird, Objekte dürfen also nicht nur teilweise in die Lösung einbezogen werden. Im Algorithmus dynamische Programmierung 