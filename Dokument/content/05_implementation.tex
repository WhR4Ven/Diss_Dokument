...
Als Referenz kann die vollständige Berechnung der idealen Lösung herangezogen werden. Sie liefert ein optimales Schedulingergebnis, ist jedoch am rechenintensivsten. Der Rechenaufwand kann effektiv dargestellt werden, indem für verschiedene Mengen an Fahrzeugen und Tasks eine optimale Verteilung errechnet wird. Zum Vergleich mit einer effizienten Scheduling Methode wird die Greedy Methode verwendet. 