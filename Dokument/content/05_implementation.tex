...
Die Benutzeroberfläche wurde als 2D Bedienoberfläche implementiert. Sie ermöglicht es dem Nutzer, die Runtime Nodes manuell zu kontrollieren und deren Statusmeldungen anzuzeigen. Für die Implementierung wurde die Softwarebibliothek Imgui verwendet. Imgui ist eine C++ Bibliothek, für die es auch Wrapper Implementierungen für andere Programmiersprachen gibt. 